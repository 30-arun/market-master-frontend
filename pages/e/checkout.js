        ...
        <div className="sm:grid max-w-screen-xl  mx-auto lg:gap-8 xl:gap-0 lg:py-8 lg:grid-cols-12">
          <div className="md:col-span-8">
            <div className="border-b pb-5">
              ...
              {loading ? (
                ...
                <div className="text-xl">
                  <span className="font-bold mt-4 ">Address:</span>{" "}
                  {shippingData.address}, {shippingData.country},{" "}
            ...
            <div className="border-b pb-5">
              ...
              {loading ? (
                ...
                <div className="text-xl">
                  <span className="font-bold mt-5 ">Method:</span>{" "}
          ...
          <div className="mt-10 lg:mt-0 md:col-span-4 border sm:ml-5">
            <div className="relative overflow-x-auto">
              ...
              <Button className="mt-7 w-full bg-cyan-700">PLACE ORDER</Button>
            </div>
          </div>
        </div>
      </div>
