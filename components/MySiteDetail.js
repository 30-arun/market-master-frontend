                    ...
                    <div className="mb-5">
                      ...
                      <p class="card-text mt-auto">
                        <small class="text-muted mt-auto">
                          Last updated: {section.time_since_updated} ago
                        </small>
                      </p>
                      {section.ecommerce && (
                        <span class="badge bg-info me-2">Ecommerce</span>
                      )}
                    </div>
                    <div class="row align-items-center">
                      ...
                      <div class="col-3">
                        <button
                          ...
                          onClick={() => handleDeleteTemp(section.id)}
                        >
            ...
            <div class="row g-4">
              <div class="col-sm-4">
                <div class="card h-100">
                  <div class="card-body">
                    <h5 class="card-title">Personal Inbox</h5>
                    <p class="card-text">
                      Dive into your personalized message center. Here, you'll
                      find all your notifications, updates, and direct messages
                      tailored just for you.
                    </p>
                    <a
                      href="#"
                      class="btn btn-light"
                      onClick={() => handleMShow(section.id)}
                    >
              ...
              <div class="col-sm-4">
                <div class="card h-100">
                  <div class="card-body">
                    ...
                    <p class="card-text">
                      Effortlessly connect to our services using the QR code
                      link. A secure and quick way to access all your necessary
                      tools and resources.
                    </p>
                    <a
                      href="#"
                  ...
                  <div class="col-sm-4">
                    <div class="card h-100">
                      <div class="card-body">
                        ...
                        <p class="card-text">
                          Explore our extensive range of products. Click here to
                          add new items to your list, discover new arrivals, and
                          find exactly what you need.
                        </p>
                        <a
                          href="#"
                          class="btn btn-light"
                          onClick={() => setPShowModal(true)}
                        >
                  ...
                  <div class="col-sm-4">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <p class="card-text">
                          See all your products here. Manage your products, and
                          keep track of your inventory, all in one place.
                        </p>
                        <a
                          href="#"
                          class="btn btn-light"
                          onClick={() => handlePSShow(section.id)}
                        >
                          <i class="fa-solid fa-eye me-2"></i>
                          See Products
                        </a>
              ...
              {section.barber && (
                <>
                  <div class="col-sm-4">
                    <div class="card h-100">
                      <div class="card-body">
                        <h5 class="card-title">Set Appointments</h5>
                        <p class="card-text">
                          Manage your appointments here. view upcoming
                          appointments, and manage your schedule, all in one
                          place.
                        </p>
                        <a
                          href="#"
                          class="btn btn-light"
                          onClick={() => handleSShow(section.id)}
                        >
                    ...
                    <div class="card h-100">
                      <div class="card-body">
                        ...
                        <a
                          href="#"
                          class="btn btn-light"
                          onClick={() => handleAShow(section.id)}
                        >
