				...
				<div class="container">
					<div class="row">
						<div class="col-md-6">
							...
							<p>
								Your Website Builder makes it easy and fun to
								create professional websites without any
								technical skills. Our mission is to empower
								everyone to bring their ideas to life online.
							</p>
						</div>
						<div class="col-md-3">
							<h5>Quick Links</h5>
