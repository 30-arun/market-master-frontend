...
const PublishModal = ({ show, handleClose, templateId }) => {
    ...
    const handleSave = () => {
        if (slug.includes(" ") || slug.length < 5) {
            swal.fire(
                "Error",
                "Subdomain must be at least 5 characters long and should not contain spaces",
                "error"
            );
            return;
        }
        ...
        axios
            ...
            .then((response) => {
                swal.fire({
                    title: "Subdomain saved successfully!",
            ...
            <Modal show={show} onHide={handleClose} keyboard={false}>
                ...
                <Modal.Body>
                    {domain.domain_name ? (
                        <>
                            <h6>
                                Enter the address where you want to publish your
                                site.
                            </h6>
                            <p>Your subdomain:</p>
                    ...
                    <div className="bg-light p-4 rounded my-3 text-center">
                        <p className="m-0 p-0">Connect your own domain.</p>
