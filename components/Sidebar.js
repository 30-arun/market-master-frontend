      ...
      >
        ...
        >
          ...
          <li className="mb-2">
            ...
            >
              <span>
                <i class="fa-solid fa-table-cells-large me-1"></i> My Sites
              </span>
              <i
                class={`fa-solid ${
                  isDropdownOpen ? "fa-chevron-up" : "fa-chevron-down"
                } dropdown-arrow ${isDropdownOpen ? "open" : ""}`}
              ></i>
            </a>
            ...
            >
              ...
              >
                {dropdownLinks.map((link) => (
                  <Link href={`/mysite/${link.id}/website/`} key={link.id}>
                    <li
                      className={
                        dropdownLinksActive(`/mysite/${link.id}/website/`)
                          ? "active my-2"
                          : "my-2"
                      }
                    >
          ...
          <Link href="/templates">
            <li className={isActive("/templates") ? "active" : ""}>
              <a href="#" class="text-decoration-none px-3 py-2 d-block mb-2">
                <i class="fa-solid fa-boxes-stacked me-1"></i> Templates
              </a>
            </li>
          </Link>
          <Link href="/qrcode">
          ...
          <Link href="/qrcode-history">
            <li className={isActive("/qrcode-history") ? "active" : ""}>
              <a href="#" class="text-decoration-none px-3 py-2 d-block mb-2">
                <i class="fa-solid fa-database me-1"></i> QR Code History
              </a>
            </li>
          </Link>
